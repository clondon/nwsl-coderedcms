...
ALLOWED_HOSTS = ['www.watfordwillsandtrusts.co.uk']
...
DEFAULT_FROM_EMAIL = 'Watford Wills And Trusts <info@watfordwillsandtrusts.co.uk>'

# A list of people who get error notifications.
ADMINS = [
    ('Administrator', 'admin@watfordwillsandtrusts.co.uk'),
]
...
#        'HOST': 'localhost',
#        'NAME': 'watfordwillsandtrusts',
#        'USER': 'watfordwillsandtrusts',
#        'PASSWORD': '',
#    }
#}
