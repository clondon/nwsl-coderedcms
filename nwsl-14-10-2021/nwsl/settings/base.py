...
INSTALLED_APPS = [
    ...
    # adding auto sass from  https://terencelucasyap.com/using-sass-django/
    # 'sass_processor',
    
    # Wagtail forms 'wagtail.contrib.modeladmin', 'wagtailstreamforms',
    # My Apps
...
BASE_URL = 'http://www.new-web-sites.com'
...
# Django Sass
# 
SASS_PROCESSOR_ROOT = os.path.join(BASE_DIR, '/static/website/src/scss')

SASS_PROCESSOR_INCLUDE_DIRS = [
    os.path.join(PROJECT_PATH, 'website/static/website/src/custom.scss')
