...
SECRET_KEY = '2x#3ulq7)y7w6qa(u6a@)(j9)ezrqvn1b)v&0l!g4170-xw17d'

# Add your site's domain name(s) here.
ALLOWED_HOSTS = ['thehornspub.co.uk']
...
DEFAULT_FROM_EMAIL = 'The Horns Pub Watford <info@thehornspub.co.uk>'

# A list of people who get error notifications.
ADMINS = [
    ('Administrator', 'admin@thehornspub.co.uk'),
]
